...
[IMPORTANT]
====
To define a schema, a `schema` xref:typedb:ROOT:fundamentals.adoc#_sessions[session] must be opened,
and a `write` xref:typedb:ROOT:fundamentals.adoc#_transactions[transaction] started.
...
more information on creating a new database, see the xref:typedb:ROOT:studio.adoc#_create_a_database[Quickstart guide].
====
////
...
xref:typedb:ROOT:quickstart/studio.adoc[Quickstart guide] for full descriptions of the following steps:
...
include::typedb:ROOT:quickstart/studio.adoc[tag=thing_deprecation]
