...
xref:typedb:ROOT:development/infer-data.adoc[inference] option is *enabled* in a *read* transaction.
...
With this rule defined and the inference option xref:typedb:ROOT:development/infer-data.adoc#_how_to_use_inference[enabled],
...
The xref:typedb:ROOT:development/infer-data.adoc#_example[Example] section of Inferring data page gives a full explanation
