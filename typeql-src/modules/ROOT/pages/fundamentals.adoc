...
include::typedb:ROOT:home/quickstart-guide.adoc[tag=thing_deprecation]
...
| Is `abstract`
| xref:clients::java/java-api-ref.adoc#_check_if_type_is_abstract_local[isAbstract();]
| xref:clients::python/python-api-ref.adoc#_check_if_type_is_abstract_local[is_abstract()]
| xref:clients::node-js/node-js-api-ref.adoc#_check_if_type_is_abstract_local[abstract;]

| Set `abstract`
| xref:clients::java/java-api-ref.adoc#_set_abstract[setAbstract();]
| xref:clients::python/python-api-ref.adoc#_set_abstract[set_abstract()]
| xref:clients::node-js/node-js-api-ref.adoc#_set_abstract[setAbstract();]

| Unset `abstract`
| xref:clients::java/java-api-ref.adoc#_unset_abstract[unsetAbstract();]
| xref:clients::python/python-api-ref.adoc#_unset_abstract[unset_abstract()]
| xref:clients::node-js/node-js-api-ref.adoc#_unset_abstract[unsetAbstract();]
|===
...
Rules can dramatically shorten complex queries, perform xref:typedb::development/infer-data.adoc#_explain_query[explainable]
...
Queries use rules for xref:typedb:ROOT:development/infer-data.adoc[Inferring new data] only in read transactions and only if
