...
xref:fundamentals/inference.adoc[inference,window=_blank].
...
the response format. See the xref:typedb:ROOT:bin/response.adoc[Response interpretation] page.
...
the IAM schema and dataset from the xref:typedb:ROOT:home/quickstart-guide.adoc[Quickstart guide].
