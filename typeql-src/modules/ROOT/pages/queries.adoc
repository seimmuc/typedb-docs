...
xref:typedb::development/define-schema.adoc#_typedb_undefine_query[Defining schema] page.
...
(use xref:typedb::development/define-schema.adoc#_typedb_define_types[define] to insert new types) and can't have the following:
