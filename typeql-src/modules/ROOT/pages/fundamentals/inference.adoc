...
When executing a `get` query with the `infer` transaction option xref:typedb:ROOT:development/infer.adoc#_how_to_use_inference[enabled]
...
* xref:typedb:ROOT:development/connect.adoc[]
...
* xref:typedb:ROOT:development/infer.adoc[]
* xref:typedb:ROOT:development/response.adoc[]
* xref:typedb:ROOT:development/api.adoc[]
* xref:typedb:ROOT:development/best.adoc[]
