...
[#_download_sample_database_schema_and_data_typeql_files]
=== Download sample database schema and data TypeQL files

For the purpose of this Quickstart guide, use the following files:

* xref:attachment$iam-schema.tql[iam-schema.tql] -- a define query for the IAM schema used in docs.
* xref:attachment$iam-data.tql[iam-data.tql] -- insert queries of minimalistic dataset for the IAM schema.
...
[#_typedb_console]
== Select a TypeDB Client to proceed with the Quickstart guide
...
Select the folder with the <<_download_sample_database_schema_and_data_typeql_files,downloaded TypeQL files>> as
