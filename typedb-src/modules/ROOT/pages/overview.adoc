...
* xref:install-and-run/install.adoc[] -- TypeDB server installation manual
...
For a more practical approach — xref:install-and-run/install.adoc[install] a TypeDB server and use our xref:quickstart.adoc[] to
