...
* xref:install-and-run/install.adoc#_install[Install TypeDB]
...
2. Find out more about how to xref:fundamentals.adoc[connect] to TypeDB, and use databases, sessions,
   and transactions.
