...
TypeDB servers accept gRPC calls from xref:clients:ROOT:clients.adoc[TypeDB Clients].
...
* GUI from xref:clients:ROOT:studio.adoc[TypeDB Studio],
* CLI from xref:clients:ROOT:console.adoc[TypeDB Console],
* API from TypeDB Drivers:
 ** xref:clients:ROOT:java/java-api-ref.adoc[Java Driver API],
 ** xref:clients:ROOT:python/python-api-ref.adoc[Python API],
 ** xref:clients:ROOT:node-js/node-js-api-ref.adoc[Node.js API],
 ** or xref:clients:ROOT:other-languages.adoc[Community TypeDB Clients].
...
xref:clients:ROOT:clients.adoc#_typedb_drivers[TypeDB Drivers] provide greater flexibility and integration with
...
* establish a server xref:development/send-queries.adoc#_clients[connection],
* open a xref:development/send-queries.adoc#_sessions[Session],
* open a xref:development/send-queries.adoc#_transactions[Transaction],
...
of how to do that with different TypeDB Drivers: xref:development/send-queries.adoc[Connection],
xref:tutorials/sample-app.adoc[Sample application] pages, or in the
xref:clients:ROOT:clients.adoc#_typedb_drivers[TypeDB Drivers] documentation.
...
xref:clients:ROOT:java/java-api-ref.adoc[Java],
xref:clients:ROOT:python/python-api-ref.adoc[Python],
xref:clients:ROOT:node-js/node-js-api-ref.adoc[Node.js].
...
xref:bin/response.adoc[Response interpretation] page.

For more information on types of response objects and their *methods* please see the xref:bin/api.adoc[API reference]
