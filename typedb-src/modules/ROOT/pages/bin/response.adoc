...
| 1
| xref:development/read-data.adoc#_get[Get query]
| Stream/Iterator of *ConceptMap*

| 2
| Get query with xref:typeql:ROOT:data/get.adoc#_aggregation[aggregation,window=_blank]
| *Future* of *Numeric*

| 3
| Get query with xref:typeql:ROOT:data/get.adoc#_group[grouping,window=_blank]
| Stream/Iterator of *ConceptMapGroup*

| 4
| Get query with xref:typeql:ROOT:data/get.adoc#_group[grouping,window=_blank] and
xref:typeql:ROOT:data/get.adoc#_aggregation[aggregation,window=_blank]
| Stream/Iterator of *NumericGroup*

| 5
| xref:development/write-data.adoc#_insert[Insert query]
| Stream/Iterator of *ConceptMap*

| 6
| xref:development/write-data.adoc#_delete_query[Delete query]
| *Future* (of empty response)

| 7
| xref:development/write-data.adoc#_update_query[Update query]
| Stream/Iterator of *ConceptMap*

| 8
| xref:development/define-schema.adoc#_typedb_define_types[Define]
| *Future* (of empty response)

| 9
| xref:development/define-schema.adoc#_typedb_undefine_query[Undefine]
| *Future* (of empty response)

| 10
| xref:development/infer-data.adoc#_explain_query[Explain]
| Stream/Iterator of *Explanation*
|===

TypeDB xref:bin/api.adoc[Driver API] methods can be used to process the objects returned: get values of attributes,
...
The ordinary xref:development/read-data.adoc#_get[Get query] (without
xref:typeql:ROOT:fundamentals/queries.adoc#_modifiers[aggregation] or
xref:typeql:ROOT:fundamentals/queries.adoc#_modifiers[grouping]) returns a stream/iterator of a ConceptMap objects.
...
For more information on inference explanation please see the xref:development/infer-data.adoc[Inferring data] page.

[#_response_formats]
== Response formats

xref:clients:ROOT:studio.adoc[TypeDB Studio] and xref:clients:ROOT:console.adoc[TypeDB Console] process the
responses automatically to present the results (in GUI and CLI respectively) to the user.

For xref:clients:ROOT:clients.adoc#_typedb_drivers[TypeDB Drivers]: the specific methods/calls used to interpret the
...
For more information please see the xref:bin/api.adoc[API & Drivers] page and documentation for the
xref:clients:ROOT:java/java-overview.adoc[Java],
xref:clients:ROOT:python/python-overview.adoc[Python], and
xref:clients:ROOT:node-js/node-js-overview.adoc[Node.js] TypeDB Drivers respectively.
...
These are used to explain xref:development/infer-data.adoc[data inference]. To perform an
xref:development/infer-data.adoc#_explain_query[explain query] use `explainables` and `explainable` objects.
