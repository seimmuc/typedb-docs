...
For more information on using TypeDB Studio, see the xref:clients::studio.adoc[] and the xref:typedb:ROOT:quickstart/studio.adoc[]
pages.
--
...
For example, complete our xref:typedb:ROOT:quickstart/studio.adoc[] with TypeDB Cloud deployment.
