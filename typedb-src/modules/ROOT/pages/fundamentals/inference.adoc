...
[#_inference]
TypeDB is capable of reasoning over data via rules xref:development/schema.adoc#_define_rules[defined] in the schema.
...
Read more on how to create rules in a schema in the xref:typedb::development/schema.adoc#_define_rules[Define rules]
section of the xref:typedb::development/schema.adoc[] page.
