...
To see how to define an abstract type see the xref:development/define-schema.adoc[Define types] section of the
xref:development/define-schema.adoc[Define schema] page.
...
xref:development/define-schema.adoc#_define_entity_type[Defining schema] page.
...
xref:development/define-schema.adoc#_define_relation_type[Defining schema] page.
...
xref:development/define-schema.adoc#_define_attribute_type[Defining schema] page.
