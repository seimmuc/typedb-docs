...
To set the IAM database follow the xref:home/quickstart-guide.adoc[].
====
...
See the xref:typeql:ROOT:fundamentals/queries.adoc#_get_query[Get query] section of the xref:typeql:ROOT:fundamentals/queries.adoc[] page.
...
An example with xref:typeql:ROOT:fundamentals/queries.adoc#_modifiers[modifiers]:
...
the IAM schema and dataset from the xref:home/quickstart-guide.adoc[Quickstart guide].
