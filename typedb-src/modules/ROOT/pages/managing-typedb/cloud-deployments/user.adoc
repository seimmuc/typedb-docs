...
1. xref:./organization.adoc#_select[Select] an active organization in the drop-down menu.
...
include::./organization.adoc[tag=invite_into_organization]
...
See the xref:./user.adoc#_team[Invite to a Team] section above.
