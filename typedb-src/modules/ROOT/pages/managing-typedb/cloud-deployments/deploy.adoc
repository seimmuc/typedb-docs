...
image::cloud.png[TypeDB Cloud web interface,width = 90%, link=self]
...
1. xref:cloud:ROOT:user-management/organization.adoc#_select[Select] an Organization to create a deployment in.
...
1. xref:cloud:ROOT:user-management/organization.adoc#_select[Select] the Organization with the deployment.
2. Open the Deployments page from the navigation menu on the left.
