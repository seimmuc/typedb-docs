...
As such, it can receive connections from xref:clients:ROOT:clients.adoc[TypeDB Clients]:
...
* Open the xref:./deploy.adoc#_details[deployment details] page.
...
include::cloud:ROOT:quickstart.adoc[tag=default-credentials]

We can configure users on in a TypeDB Enterprise server/cluster with TypeDB Console or with Driver API methods
for xref:clients:ROOT:java/java-api-ref.adoc#_users[Java],
xref:clients:ROOT:python/python-api-ref.adoc#_users[Python], and
...
+
--
We can use the xref:clients:ROOT:studio.adoc#_connect_to_typedb_server[basic connection guide] to connect to a TypeDB Cloud
...
image::studio-connect-cluster.png[Connect to Studio window, width = 70%, link=self]
...
For more information on using TypeDB Studio, see the xref:clients:ROOT:studio.adoc[] and the xref:home/quickstart-guide.adoc[]
pages.
--
...
+
--
include::cloud:ROOT:quickstart.adoc[tag=console-connect]
--
...
xref:clients:ROOT:java/java-api-ref.adoc#_instantiating_a_typedb_cluster_client[reference].

See the xref:clients:ROOT:java/java-tutorial.adoc[] page to learn more about using the library.
--
...
xref:clients:ROOT:python/python-api-ref.adoc#_instantiating_a_typedb_cluster_client[reference].

See the xref:clients:ROOT:python/python-tutorial.adoc[] page to learn more about using the library.
--
...
xref:clients:ROOT:node-js/node-js-api-ref.adoc#_instantiating_a_typedb_cluster_client[reference].

See the xref:clients:ROOT:node-js/node-js-tutorial.adoc[] page to learn more about using the library.
--
====
...
to send some xref:typeql:ROOT:fundamentals/queries.adoc[queries] to the server.

For example, complete our xref:home/quickstart-guide.adoc[] with TypeDB Cloud deployment.

For more information, see the following:

* xref:overview.adoc[TypeDB documentation] for a general understanding of how to use TypeDB server,
* xref:clients:ROOT:clients.adoc[TypeDB Clients documentation] for information on how to use Driver API methods,
TypeDB Studio GUI, or TypeDB Console CLI,
* xref:typeql:ROOT:overview.adoc[TypeQL documentation] for an advanced understanding of building a query and using patterns.
