...
Open the xref:./account.adoc#_settings[Account settings] page.
...
include::./organization.adoc[tag=intro]

include::./organization.adoc[tag=join_organization]

=== Team

include::./team.adoc[tag=intro]

include::./team.adoc[tag=invite]

=== Project

include::./projects.adoc[tag=intro]

include::./projects.adoc[tag=user]

See the xref:./account.adoc#_team[Team] section above.
