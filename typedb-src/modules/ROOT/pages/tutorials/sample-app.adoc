...
xref:install-and-run/install.adoc[Installation guide] to prepare the server
and the xref:quickstart/studio.adoc[Quickstart guide] to prepare the database.
