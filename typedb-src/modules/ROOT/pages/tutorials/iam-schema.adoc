...
[NOTE]
====
The terminology used in the IAM xref:quickstart/studio.adoc#_iam_schema[schema] is defined
...
Check our xref:quickstart/studio.adoc[Quickstart guide] for step-by-step instructions how to load the schema and data to a
TypeDB database.
====
...
The sample dataset that we loaded in the xref:quickstart/studio.adoc#_iam_microdataset[Quickstart guide]
