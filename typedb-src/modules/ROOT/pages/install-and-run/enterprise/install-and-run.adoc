...
TypeDB Enterprise runs on macOS, Linux and Windows. The only requirement is Java (version 11 or higher) which can be
...
Next, we'll learn how to deploy TypeDB Enterprise using
xref:typedb::install-and-run/enterprise/kubernetes.adoc[Kubernetes] and Helm.
