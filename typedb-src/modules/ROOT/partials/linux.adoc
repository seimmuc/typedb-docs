...
Run the following command in a terminal to start a TypeDB server:
...
TypeDB will run in the foreground. If the terminal running TypeDB is closed, TypeDB will be shut down.
// end::start[]
