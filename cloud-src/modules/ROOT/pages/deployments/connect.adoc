...
image::typedb::studio-connect-cluster.png[Connect to Studio window, width = 70%, link=self]

Use the btn:[Manage cluster addresses] button to set the address of a server to connect.

image::typedb::studio-manage-cluster-address.png[Connect to Studio window, width = 70%, link=self]
...
For more information on using TypeDB Studio, see the xref:clients::studio.adoc[] and the xref:typedb:ROOT:home/quickstart-guide.adoc[]
pages.
--
...
For example, complete our xref:typedb:ROOT:home/quickstart-guide.adoc[] with TypeDB Cloud deployment.
