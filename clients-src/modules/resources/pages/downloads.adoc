...
// tag::clients-downloads[]
== TypeDB Console

TypeDB Console is distributed with both TypeDB Core and TypeDB Enterprise.

Check your distributive of TypeDB for a
xref:clients::console.adoc#_version_compatibility[compatible] version of TypeDB Console.
Alternatively, xref:typedb:resources:download-center.adoc#_typedb_core[download] TypeDB with TypeDB Console inside.
