...
Instantiate a TypeDB Core client and open a xref:typedb:ROOT:fundamentals.adoc#_sessions[session] to a
xref:typedb:ROOT:fundamentals.adoc#_databases[database].

[NOTE]
====
Find out how to create a database in TypeDB on the
xref:typedb:ROOT:quickstart/studio.adoc#_create_a_database[Quickstart guide] page.
