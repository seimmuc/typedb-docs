...
This connection opens us basic features of xref:typedb:ROOT:development/send-queries.adoc#_databases[database] management, user
...
See the xref:typedb:ROOT:bin/response.adoc[Response interpretation] page to find information of possible
response to different query types.

The `ConceptMap` objects returned by a xref:typedb::development/read-data.adoc#_get[Get query] can contain
