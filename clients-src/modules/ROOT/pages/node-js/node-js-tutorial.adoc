...
* xref:typedb::development/write-data.adoc#_insert[Insert]
* xref:typedb::development/write-data.adoc#_delete_query[Delete]
* xref:typedb::development/write-data.adoc#_update_query[Update]
* xref:typedb::development/read-data.adoc#_get[Get]
