...
Produces a Map where keys are query variables, and values are xref:typedb:ROOT:bin/response.adoc#_concept[concepts].
...
Return a collection of all the xref:typedb:ROOT:bin/response.adoc#_concept[concepts] in this ConceptMap.
